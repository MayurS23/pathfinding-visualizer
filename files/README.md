...
- 🎛️ **Speed Control** — adjust animation from slow (learning) to instant (benchmarking)
...
> ⚠️ Must use a local server. Opening `index.html` directly (`file://`) will fail due to browser security restrictions on WebAssembly.
